...
public interface ViewModelObserver extends Remote {
	...
	void updateGame (String name, String hp, String kmh, String consumption, String ccm, String acceleration, boolean isPlayer1active, int numberOfCards, String jpgUrl, String status)  throws RemoteException;
